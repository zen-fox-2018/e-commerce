<template>
 <div class="card mb-3">
        ...
        <p><a @click="$emit('change_page','list_product')">back</a><i>Updated Product</i></p>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" style="width: 120px; height: 100px;" :src="product.img" data-holder-rendered="true">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="form-group">
...
export default {
  ...
  props: ['categories', 'product_update'],
  methods: {
    get_image (event) {
    ...
    show_product () {
      this.product.title = this.product_update.title
      this.product.price = this.product_update.price
      this.product.stock = this.product_update.stock
      this.product.description = this.product_update.description
      this.product.img = this.product_update.img
      this.product.id = this.product_update._id
    }
  },
  created () {
    this.show_product()
